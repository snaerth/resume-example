        ...
        <div>
          ...
          {section.text
            ? <div className="resume-section--row">
                <div className="resume-row"><p>{section.text}</p></div>
              </div>
            : null}
    ...
    if (images.length > 2) {
      ...
      return (
        <div className="extend">
          <div className="even">{left}</div>
          <div className="odd">{right}</div>
        </div>
      );
    } else {
    ...
    return (
      <div>
        ...
        <div className="resume-container" ref="container">
          ...
          {this.renderSection(relationships, 5, true)}
        </div>
      </div>
    );
  }
